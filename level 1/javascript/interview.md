...
Break statement is used **to come out of the current loop** 
 continue statement **continues the current loop with a new recurrence.**

# 72. How are DOM utilized in JavaScript?

DOM stands for Document Object Model and is responsible for how various objects in a document interact with each other. DOM is required for developing web pages, which includes objects like paragraph, links, etc. 
